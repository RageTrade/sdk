...
export interface CurveYieldStrategyTestInterface extends utils.Interface {
  functions: {
...
export interface CurveYieldStrategyTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveYieldStrategyTestInterface;
