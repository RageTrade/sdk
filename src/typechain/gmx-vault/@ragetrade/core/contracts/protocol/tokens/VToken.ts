...
export interface VTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'allowance'
      | 'approve'
...
export interface VToken extends BaseContract {
  ...
  setVPoolWrapper: TypedContractMethod<
    [_vPoolWrapper: AddressLike],
    [void],
    'nonpayable'
  >;
  ...
  vPoolWrapper: TypedContractMethod<[], [string], 'view'>;
  ...
  getFunction(
    nameOrSignature: 'setVPoolWrapper'
  ): TypedContractMethod<[_vPoolWrapper: AddressLike], [void], 'nonpayable'>;
  getFunction(
