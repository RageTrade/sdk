...
} from '../../../../../../@ragetrade/core/contracts/interfaces/clearinghouse/IClearingHouseOwnerActions';
...
export class IClearingHouseOwnerActions__factory {
  ...
  static createInterface(): IClearingHouseOwnerActionsInterface {
    return new Interface(_abi) as IClearingHouseOwnerActionsInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IClearingHouseOwnerActions;
  }
}
