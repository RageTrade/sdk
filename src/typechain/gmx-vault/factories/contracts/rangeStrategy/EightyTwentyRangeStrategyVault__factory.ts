...
import type {
  ...
  EightyTwentyRangeStrategyVaultInterface,
} from '../../../contracts/rangeStrategy/EightyTwentyRangeStrategyVault';
...
export class EightyTwentyRangeStrategyVault__factory {
  ...
  static createInterface(): EightyTwentyRangeStrategyVaultInterface {
    return new Interface(_abi) as EightyTwentyRangeStrategyVaultInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as EightyTwentyRangeStrategyVault;
  }
}
