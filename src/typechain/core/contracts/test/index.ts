...
/* tslint:disable */
/* eslint-disable */
import type * as batchedLoopTestSol from './BatchedLoopTest.sol';
export type { batchedLoopTestSol };
import type * as governableSol from './Governable.sol';
export type { governableSol };
...
export type { WordHelperTest } from './WordHelperTest';
