...
export class VToken__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): VToken__factory {
    return super.connect(runner) as VToken__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VTokenInterface {
    return new Interface(_abi) as VTokenInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): VToken {
    return new Contract(address, _abi, runner) as unknown as VToken;
  }
}
