...
export class DnGmxBatchingManagerGlp__factory extends ContractFactory {
  ...
  override connect(
    ...
    return super.connect(runner) as DnGmxBatchingManagerGlp__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): DnGmxBatchingManagerGlpInterface {
    return new Interface(_abi) as DnGmxBatchingManagerGlpInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as DnGmxBatchingManagerGlp;
  }
}
