...
export class DnGmxSeniorVault__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): DnGmxSeniorVault__factory {
    return super.connect(runner) as DnGmxSeniorVault__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): DnGmxSeniorVaultInterface {
    return new Interface(_abi) as DnGmxSeniorVaultInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): DnGmxSeniorVault {
    return new Contract(address, _abi, runner) as unknown as DnGmxSeniorVault;
  }
}
