...
export class FeeSplitStrategyMock__factory extends ContractFactory {
  ...
  ): FeeSplitStrategyMock__factory {
    return super.connect(runner) as FeeSplitStrategyMock__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): FeeSplitStrategyMockInterface {
    return new Interface(_abi) as FeeSplitStrategyMockInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as FeeSplitStrategyMock;
  }
}
