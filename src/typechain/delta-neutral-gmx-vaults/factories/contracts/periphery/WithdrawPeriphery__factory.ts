...
export class WithdrawPeriphery__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): WithdrawPeriphery__factory {
    return super.connect(runner) as WithdrawPeriphery__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): WithdrawPeripheryInterface {
    return new Interface(_abi) as WithdrawPeripheryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): WithdrawPeriphery {
    return new Contract(address, _abi, runner) as unknown as WithdrawPeriphery;
  }
}
