...
export class BatchingManagerBypass__factory extends ContractFactory {
  ...
  override connect(
    ...
    return super.connect(runner) as BatchingManagerBypass__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): BatchingManagerBypassInterface {
    return new Interface(_abi) as BatchingManagerBypassInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as BatchingManagerBypass;
  }
}
