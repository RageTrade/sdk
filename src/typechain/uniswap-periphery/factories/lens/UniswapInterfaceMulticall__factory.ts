...
} from '../../lens/UniswapInterfaceMulticall';
...
export class UniswapInterfaceMulticall__factory extends ContractFactory {
  ...
  override connect(
    ...
    return super.connect(runner) as UniswapInterfaceMulticall__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): UniswapInterfaceMulticallInterface {
    return new Interface(_abi) as UniswapInterfaceMulticallInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as UniswapInterfaceMulticall;
  }
}
