...
export interface ETHIndexOracleInterface extends utils.Interface {
  contractName: 'ETHIndexOracle';
  functions: {
...
export interface ETHIndexOracle extends BaseContract {
  contractName: 'ETHIndexOracle';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ETHIndexOracleInterface;
