...
export interface ETHVPoolInterface extends utils.Interface {
  contractName: 'ETHVPool';
  functions: {
...
export interface ETHVPool extends BaseContract {
  contractName: 'ETHVPool';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ETHVPoolInterface;
