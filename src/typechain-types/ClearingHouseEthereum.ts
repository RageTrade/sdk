...
export interface ClearingHouseEthereumInterface extends ethers.utils.Interface {
  functions: {
...
export interface ClearingHouseEthereum extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ClearingHouseEthereumInterface;
