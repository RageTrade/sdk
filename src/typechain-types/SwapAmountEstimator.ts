...
export interface SwapAmountEstimatorInterface extends ethers.utils.Interface {
  functions: {
...
export interface SwapAmountEstimator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwapAmountEstimatorInterface;
