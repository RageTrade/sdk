...
export interface ClearingHouseDummyInterface extends ethers.utils.Interface {
  functions: {
    ...
    'newMethodAdded()': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'newMethodAdded',
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ClearingHouseDummy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ClearingHouseDummyInterface;
  ...
  functions: {
    ...
    newMethodAdded(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    newMethodAdded(overrides?: CallOverrides): Promise<PopulatedTransaction>;
