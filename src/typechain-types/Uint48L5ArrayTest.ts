...
export interface Uint48L5ArrayTestInterface extends utils.Interface {
  contractName: 'Uint48L5ArrayTest';
  functions: {
    'exclude(uint48)': FunctionFragment;
    'exists(uint48)': FunctionFragment;
    'getter(uint8)': FunctionFragment;
    'getterAll()': FunctionFragment;
    'include(uint48)': FunctionFragment;
    'length()': FunctionFragment;
    'numberOfNonZeroElements()': FunctionFragment;
    'setter(uint8,uint48)': FunctionFragment;
  };
...
export interface Uint48L5ArrayTest extends BaseContract {
  contractName: 'Uint48L5ArrayTest';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Uint48L5ArrayTestInterface;
