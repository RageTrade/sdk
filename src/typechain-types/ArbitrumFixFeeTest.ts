...
export interface ArbitrumFixFeeTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    'testMethod(uint256)': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'emitGasCostWei',
    values?: undefined
  ): string;
  ...
  decodeFunctionResult(functionFragment: 'testMethod', data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: 'transferGovernance',
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    'Uint(string,uint256)': EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: 'GovernanceTransferred'): EventFragment;
  getEvent(nameOrSignatureOrTopic: 'TeamMultisigTransferred'): EventFragment;
  getEvent(nameOrSignatureOrTopic: 'Uint'): EventFragment;
}
...
export type UintEvent = TypedEvent<
  [string, BigNumber],
  { str: string; val: BigNumber }
>;

export type UintEventFilter = TypedEventFilter<UintEvent>;

export interface ArbitrumFixFeeTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArbitrumFixFeeTestInterface;
  ...
  callStatic: {
    ...
    emitGasCostWei(overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    'Uint(string,uint256)'(str?: null, val?: null): UintEventFilter;
    Uint(str?: null, val?: null): UintEventFilter;
  };
