...
export interface TimelockControllerWithMinDelayOverrideTestInterface
  ...
  functions: {
    ...
    'getKey(address,bytes4)': FunctionFragment;
    'getMinDelay()': FunctionFragment;
    'getMinDelayOverride(address,bytes4)': FunctionFragment;
    'getRoleAdmin(bytes32)': FunctionFragment;
    'getSelector(address,uint256,bytes,bytes32,bytes32,uint256)': FunctionFragment;
...
export interface TimelockControllerWithMinDelayOverrideTest
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TimelockControllerWithMinDelayOverrideTestInterface;
